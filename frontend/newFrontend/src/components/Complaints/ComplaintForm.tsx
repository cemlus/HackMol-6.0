...
// // Mock function to get AI suggestions based on complaint type
// const getAISuggestions = (complaintType: string): string[] => {
//   switch (complaintType) {
//     case "theft":
//       return ["License plate number: ", "Vehicle make and model: ", "Items stolen: ", "Approximate time: "]
//     case "assault":
//       return ["Description of the assailant: ", "Injuries sustained: ", "Witnesses present: "]
//     case "medical":
//       return ["Symptoms: ", "Medical history: ", "Current medications: "]
//     case "fire":
//       return ["Source of fire: ", "Extent of damage: ", "People trapped: "]
//     case "harassment":
//       return ["Nature of harassment: ", "Duration: ", "Previous incidents: "]
//       case "vandalism":
//         return ["The place of origin: ", "Number of People: "]
//       case "fraud":
//         return ["Form of scam: ", "Contract Description"]
//       case "noise":
//         return ["Neighbour Disturbance", "Community Based"]
//     default:
//       return []
//   }
// }

// // Mock function to get subtypes based on complaint type
// const getSubtypes = (complaintType: string): string[] => {
//   switch (complaintType) {
//     case "theft":
//       return ["Vehicle", "Electronics", "Personal Belongings", "Home Invasion"]
//     case "assault":
//       return ["Physical", "Verbal", "Sexual", "Domestic"]
//     case "medical":
//       return ["Emergency", "Accident", "Illness", "Mental Health"]
//     case "fire":
//       return ["Residential", "Commercial", "Forest", "Vehicle"]
//     case "harassment":
//       return ["Workplace", "Online", "Stalking", "Neighbor Dispute"]
//     case "vandalism":
//       return ["Monument", "Private Property", "Public Property"]
//     case "fraud":
//       return ["Investment Scams", "Identity Iheft", "Payment Fraud", "Romance Crimes", "Cybercrime"]
//     case "noise":
//       return ["Neighbour Disturbance", "Community Based"]
//     default:
//       return ["Other"]
...
//                 <Label htmlFor="complaintSubtype" className="text-gray-700">
//                   Complaint Subtype
//                 </Label>
//                 <select
//                   id="complaintSubtype"
//                   {...register("complaintSubtype", { required: "Please select a subtype" })}
//                   className={cn(
//                     "w-full px-3 py-2 border rounded-md",
//                     errors.complaintSubtype ? "border-red-500" : "border-gray-300",
//                   )}
//                 >
//                   <option value="">Select a subtype</option>
//                   {getSubtypes(complaintType).map((subtype) => (
...
//               className="bg-[#2A3B7D] hover:bg-[#1e2a5a] text-white"
//               disabled={
//                 (currentStep === 1 && (!complaintType || !watch("complaintSubtype"))) ||
...
const ComplaintForm: React.FC<ComplaintFormProps> = ({ onSubmit }) => {
  ...
  return (
    <Card className="p-6 max-w-2xl mx-auto">
      ...
      >
        <h2 className="text-2xl font-bold text-center text-[#2A3B7D] mb-6">
        ...
        <div className="mb-8">
            ...
            {[1, 2, 3].map((stepNumber) => (
              ...
              >
                <div className={`w-8 h-8 rounded-full flex items-center justify-center ${
                  step >= stepNumber ? "bg-[#2A3B7D] text-white" : "bg-gray-200"
                }`}>
                  {stepNumber}
                </div>
          ...
          <div className="w-full bg-gray-200 h-2 rounded-full mt-2">
            <div 
              className="bg-[#2A3B7D] h-2 rounded-full transition-all duration-300"
          ...
          >
            <div className="space-y-4">
              ...
              <div className="flex justify-end mt-6">
                <Button onClick={nextStep} className="bg-[#2A3B7D]">
                  Continue
                </Button>
              </div>
            </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Street address or description" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field: { value, onChange, ...field } }) => (
                  <FormItem>
                    ...
                    <p className="text-sm text-gray-500">
                      Photos, videos, or documents relevant to your complaint
                    </p>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea 
                        placeholder="Any other details that may be helpful..."
                        className="min-h-24"
                        {...field}
                      />
                    </FormControl>
